...
public class SearchServiceImpl implements SearchService {
    ...
    public Goods buildGoods(Spu spu) {
        ...
        goods.setAll(all);   // 搜索字段，包含分类、品牌、标题、规格等
        goods.setSkus(JsonUtils.toString(skus));    //   所有sku的json集合
        goods.setPrice(prices);   //    所有sku的价格集合
        goods.setSpecs(specs);   //     所有的可搜索参数规格
    ...
    public PageResult<Goods> search(SearchRequest request) {
        ...
        int totalPage = result.getTotalPages(); //总页数
    ...
    private List<Map<String, Object>> buildSpecificationAgg(Long cid, QueryBuilder basicQuery) {
        ...
        for (SpecParam param : params) {
            ...
            String name = param.getName();  //规格参数名
